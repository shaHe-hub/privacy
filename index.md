...
Synzi（以下简称“本应用”）高度重视用户隐私的保护。本隐私政策详细阐述了我们如何收集、使用、存储和保护您的个人信息。请您在使用本应用前仔细阅读本政策；一旦使用本应用，即表示您同意本政策所述内容。
...
我们不收集任何可识别个人身份的信息，也无法访问您在Synzi中创建的任何内容。您在本应用中的所有数据均归您自己所有。
